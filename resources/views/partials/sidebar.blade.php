@php
    function navClass($route)
    {
        return request()->routeIs($route)
            || ($route === 'equipment.index' && request()->routeIs('equipment.show'))
            || ($route === 'reports.index' && request()->routeIs('reports.*'))
            ? 'pmms-nav-link-active'
            : 'pmms-nav-link-inactive';
    }
    ...
    $navItems = [
        ...
        [
            ...
            'label' => 'Employees',
            'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-9.75 9.75a4.5 4.5 0 0 1 9 0v.75a2.25 2.25 0 0 1-2.25 2.25h-4.5A2.25 2.25 0 0 1 6 16.5v-.75Zm13.5-.75a4.5 4.5 0 0 0-4.5-4.5h-.75a2.25 2.25 0 0 0-2.25 2.25v.75a2.25 2.25 0 0 0 2.25 2.25h.75a4.5 4.5 0 0 0 4.5-4.5Z" />',
        ],
        [
            'route' => 'equipment-categories.index',
            'label' => 'Equipment Categories',
            'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 0 0 3 5.25v4.318c0 .597.237 1.169.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 0 0 5.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 0 0 9.568 3Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M6 6h.008v.008H6V6Z" />',
        ],
        [
        ...
        [
            'route' => 'preventive-maintenances.index',
            'label' => 'PM Logs',
...
<aside class="sticky top-0 flex h-screen w-64 shrink-0 flex-col border-r border-slate-800/50 bg-slate-900 text-white print:hidden">

    <div class="border-b border-slate-800 px-6 py-5">
        <div class="flex items-center gap-3">
            <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-500 text-sm font-bold text-white shadow-lg shadow-indigo-500/30">
                PM
            </div>
            <div>
                <p class="text-base font-bold tracking-tight">NCIP - MIGS</p>
                <p class="text-xs text-slate-400">Preventive Maintenance</p>
            </div>
        </div>
    </div>
